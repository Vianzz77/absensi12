...
<head>
  ...
  <title>SMK N 1 Slawi | Log in</title>
  <link rel="shortcut icon" href="<?= base_url() ?>assets/gambar/logo/fav/rpl.png" type="image/x-icon">
  <link rel="icon" href="<?= base_url() ?>assets/gambar/logo/fav/rpl.png" type="image/x-icon">
...
<body class="hold-transition login-page">
  <div class="login-box" style="margin-top:5%;">
    <div class="login-logo">
      <a href="<?= site_url() ?>"><img src="<?= base_url() ?>assets/gambar/logo/rpl.png" style="max-width:50%;"></a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
      <p class="login-box-msg">Selamat datang di Absensi SMK N 1 Slawi</p>
      <br>
      ...
      <form action="<?= site_url('login') ?>" method="post">
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <br><center><p>Channel Youtube <a href='' title='' target='_blank'>Cnid Code</a></p></center>
          </div>
